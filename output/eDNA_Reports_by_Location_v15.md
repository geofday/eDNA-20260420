...
**Conservation significance: If this tributary's extreme acidity is natural, it is a permanent barrier to Brook Trout recolonization of this reach regardless of any other restoration action. If it is anthropogenic (acid rain legacy or point source), remediation may be possible. Source investigation — bog mapping and upstream chemistry transect — is the necessary next step.**
...
**Fish:** H<sub>f</sub> = 0.27 · 6 species/genera · ~10,680 reads *(corrected to include genus-level ESVs)*

| Species | Rel% | Note |
|---|---|---|
| *Notemigonus crysoleucas* — Golden Shiner | ~75.8% | Native — dominant |
| *Lepomis* spp. — Sunfish | 9.9% | Native — genus-level only |
| *Anguilla rostrata* — American Eel | ~2.0% | Native catadromous |
| *Alosa pseudoharengus* — Alewife | ~0.8% | Native anadromous |
...
*Note: Salvelinus spp. (1.1%, ~114 reads) and Lepomis spp. (9.9%) were previously excluded due to genus-level ESV. Reads corrected; other percentages re-normalized.*

Sawmill Brook at the Atwater monitoring site in June: Golden Shiner dominant. **Brook Trout (*Salvelinus* spp.) detected at 1.1% (~114 reads)** — a low but real signal at this Atwater reach. Low diversity and high Shiner dominance in June may reflect post-spawn aggregation behavior. Alewife at ~0.8% confirms ocean connectivity. *Lepomis* spp. (9.9%) is a significant genus-level sunfish detection — consistent with the pond or slow-water reaches connected to this stretch of Sawmill Brook.

**Brook Trout** is now confirmed at the Atwater site at low level in June 2025. Compare with November 2023 (JVB5776) and August 2024 (JVB3787), which confirmed Brook Trout at 2.5% at the School St site (a different reach upstream). Continued time-series data at Atwater will clarify the seasonal detection pattern.
