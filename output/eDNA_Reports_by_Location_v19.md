...
| *Anguilla rostrata* — American Eel | 2.0% | Native catadromous |
| ***Esox lucius* — Northern Pike** | **1.5%** | **ILLEGAL STOCKING in Massachusetts. Report to MA DFW immediately.** |
| **Brook Trout** | **Absent** | |
...
The fish community is ecologically coherent: Alewife at 63% confirms the pond supports a lake-run population (landlocked alewife are common in Manchester-area coastal ponds); Tessellated Darter at 5% endorses substrate quality; **Northern Pike at 1.5% is the critical finding** — this species is not native to Massachusetts coastal drainages and is illegal to stock in this state. Detection here requires reporting to Massachusetts Division of Fisheries & Wildlife for investigation and management response.

### Native vs. Non-Native

All species except Northern Pike are native. **Northern Pike (*Esox lucius*) is non-native and its stocking is illegal in Massachusetts. Report to MA DFW.**
