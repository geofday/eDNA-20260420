...
East Machias Rt 9 in October is a tidal freshwater mixing zone wearing its marine signature openly. *Halamphora coffeaeformis* — a brackish/marine diatom — at 50.6% is the most dominant single taxon in the JVB3988 algal dataset, confirming that tidal saltwater reaches the Rt 9 sampling point in autumn when freshwater flows are low. Despite the tidal mixing, cold-water quality indicators (*Mallomonas*, *Monomastix*) persist, and Cyanobacteria are low at 6.5%. The fish community — Blueback Herring 87%, Fallfish 7%, Eel 4% — is the fall anadromous run in full flood. No Brook Trout, as expected at a tidal mainstem reach.
...
| Tidal influence | **Confirmed — dominant** | *H. coffeaeformis* 50.6% |
...
| *Semotilus corporalis* — Fallfish | 7.0% | Native clean-gravel indicator |
...
| **Brook Trout** | **Absent** | Tidal mainstem — not expected |
| **Atlantic Salmon** | **Absent** | |
...
| Taxon | Phylum | Rel% | Note |
|---|---|---|---|
| *Halamphora coffeaeformis* | Bacillariophyta | 50.6% | **Tidal/brackish diatom — dominant** |
...
The 50.6% *Halamphora coffeaeformis* at East Machias Rt 9 tells the story of an October low-flow period when the tidal signature penetrates far upstream. *H. coffeaeformis* is a well-known indicator diatom of brackish and marine conditions; its dominance in autumn confirms that saltwater mixing at this reach is seasonally significant, most pronounced when freshwater discharge is at its lowest after summer. This tidal influence is not impairment — it is the natural estuarine character of the lower East Machias, and it is exactly the ecological context that makes these reaches productive habitat for migratory fish aggregating ahead of upstream passage.

The cold-water quality indicators — *Mallomonas*, *Monomastix* — at modest but meaningful proportions confirm that freshwater inputs to this reach remain cold and soft, consistent with the spruce-fir drainage upstream. Streptophyta at 8.5% reflects October leaf-fall inputs from the riparian corridor. *Nostoc linckia* at 0.4% signals exposed substrate at low flow.
...
**Fish:** H<sub>f</sub> = 1.16 · 5 species · 21,847 reads · **Atlantic Salmon 1.1% confirmed**
**Algae:** H<sub>a</sub> = 2.24 · 31 ESVs · 6,809 reads

### Sentinel Signal

Northern Stream in October carries a quiet but unmistakable boreal headwater signature. *Mougeotia* at 6.9% — a filamentous streptophyte alga characteristic of cold, soft, acidic streams — is the ecological centerpiece of this algal community and a direct companion indicator of Brook Trout habitat chemistry. *Picea* (spruce) at 3.4% is eDNA from the surrounding boreal forest entering the stream — a geographic fingerprint confirming remote spruce-fir drainage, the kind of watershed that is still producing wild Atlantic Salmon. *Chamaesiphon* at 2.4% is the clean-flowing-water signature: this epiphytic cyanobacterium lives attached to filamentous algae on stable substrate in cold streams, and its presence is incompatible with impaired or degraded conditions. **Atlantic Salmon detected at 1.1%** — these are spawning-run fish in a natal tributary. Report to NOAA Fisheries and Maine DMR.
...
| Watershed character | Remote boreal forest | *Picea* (spruce) 3.4% — forest eDNA in stream |
...
| Species | Rel% | Note |
|---|---|---|
| *Alosa pseudoharengus* — Alewife | 52.0% | Native anadromous — fall run |
| *Semotilus corporalis* — Fallfish | 30.0% | Native clean-gravel indicator |
| *Catostomus commersonii* — White Sucker | 14.0% | Native |
| ***Salmo salar* — Atlantic Salmon** | **1.1%** | **Gulf of Maine DPS — federally endangered. Spawning run fish in natal tributary. Report to NOAA Fisheries and Maine DMR.** |
| *Anguilla rostrata* — American Eel | 3.0% | Native catadromous |
| **Brook Trout** | **Absent** | |
...
| *Picea* sp. — Spruce | Streptophyta | 3.4% | **Boreal forest watershed fingerprint** |
...
*Mougeotia* is a filamentous conjugating green alga (Streptophyta) that grows in dense green mats on rocks and submerged wood in cold, soft, slightly acidic streams. It is the most common and most reliable soft-acid-cold-water macroalgal indicator in the Maine headwater literature. Its co-occurrence with *Chamaesiphon* — which requires stable, clean substrate and cold flowing water for attachment — makes the water quality interpretation unambiguous. *Picea* DNA at 3.4% is not an aquatic organism; it is spruce pollen and leaf/needle debris entering the stream from the surrounding boreal forest, and its presence is a geographic indicator of the remoteness and forested character of the watershed.

The Alewife at 52% and Fallfish at 30% in the fish community confirm an October run in a clean gravel-bottomed tributary with excellent ocean connectivity. The Atlantic Salmon at 1.1% are the biological confirmation of everything the algae suggested: this is a natal tributary in good enough condition to attract returning adult Salmon on their spawning run.
...
**Fish:** H<sub>f</sub> = 1.05 · 3 species · 9,437 reads
**Algae:** H<sub>a</sub> = 1.89 · 21 ESVs · 3,076 reads *(lower read count — interpret cautiously)*

### Sentinel Signal

Northern Outlet is the lower-confidence sample in JVB3988 — 3,076 algal reads is at the lower end of reliable interpretation. The dominant signal is an unresolved diatom bloom (46.3%) at a site with partial tidal influence (*Halamphora coffeaeformis* 8.8%). Cyanobacteria at 17.4% includes *Synechococcus* and *Vulcanococcus* — warm-water picocyanobacteria indicating some late-summer nutrient accumulation. *Pseudopedinella elastica* (1.3%) is a cold-water chrysophyte mixotroph. A *Chrysochromulina* trace (1.4%) appears. Fish show Eel 43%, White Sucker 32%, Fallfish 24% — a mixed community at a transitional reach.
...
| Tidal influence | Partial | *H. coffeaeformis* 8.8% |
...
| Species | Rel% | Note |
|---|---|---|
| *Anguilla rostrata* — American Eel | 43.0% | Native catadromous — tidal reach |
| *Catostomus commersonii* — White Sucker | 32.0% | Native |
| *Semotilus corporalis* — Fallfish | 24.0% | Native clean-water indicator |
| **Brook Trout** | **Absent** | |
| **Atlantic Salmon** | **Absent** | |
...
| *Halamphora coffeaeformis* | Bacillariophyta | 8.8% | Tidal influence |
...
Northern Outlet sits at a transitional position — lower in the watershed than Northern Stream, with more tidal influence and more Cyanobacteria signal. The lower read count (3,076) reduces confidence in the proportional estimates, but the directional interpretation is consistent with expectations for a lower-reach, partially tidal site. Fallfish at 24% in the fish community is a positive sign for substrate quality even at this tidal-influenced reach.
...
| Species | Rel% | Note |
|---|---|---|
| *Semotilus atromaculatus* — Creek Chub | 72.0% | Native — moderate-quality headwater |
| *Rhinichthys* spp. — Dace | 17.0% | Native clean-water cyprinid |
| *Catostomus commersonii* — White Sucker | 7.0% | Native |
| *Anguilla rostrata* — American Eel | 4.0% | Native catadromous — ocean connectivity |
| **Brook Trout** | **Absent** | |
| **Atlantic Salmon** | **Absent** | |
...
The Creek Chub (72%) and Dace (17%) fish community is characteristic of headwater streams in the mid-reach — above tidal influence, below the coldest headwater springs. Neither species is as demanding as Brook Trout, but both require clean water and stable substrate. The Eel at 4% confirms ocean connectivity through the East Machias system.
...
| Species | Rel% | Note |
|---|---|---|
| ***Esox* spp. — likely Chain Pickerel** | **47.8%** | **Native; genus-level ID (multi-species match). Spring spawning season — peak eDNA shedding.** |
...
| ***Esox* spp. — likely Chain Pickerel** | **20.0%** | **Native; genus-level ID** |
...
| ***Esox* spp. — likely Chain Pickerel** | **7.7%** | **Native; genus-level ID** |
...
| ***Esox* spp. — likely Chain Pickerel** | **4.1%** | **Native; genus-level ID** |
...
| JVB4981 | Union River, MBTS, Cape Cod, Mashpee | May–Jun 2025 | **Detected at Orange River — 1.0% (May 14).** Absent elsewhere; herring run masking possible at Union/Mashpee |
...
|---|---|---|---|---|---|
| East Machias Rt 9 | Oct 2024 | 1.86 | 6.5% | Tidal dominant (*H. coffeaeformis* 50.6%) | No |
| **Northern Stream** | Oct 2024 | 2.24 | 17.9%* | ***Mougeotia*, *Chamaesiphon*, *Picea*** | No |
| Northern Outlet | Oct 2024 | 1.89 | 17.4% | Tidal influence; lower read count | Low reads |
