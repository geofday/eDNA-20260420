# Narraguagus Watershed eDNA Report
## Deblois, Maine — November 2023
...
**Methods:** All samples were collected using Jonah Ventures (JV) eDNA field kits following recommended field-sterile procedures. All samples were mailed to JV for processing. Fish samples were analyzed using the MiFish 12S rRNA barcode; all samples were also analyzed for algae using the 23S rRNA barcode. Results were processed in MS Excel and later using Artificial Intelligence (Claude) for analysis.
...
Algal reports deepen this focus and add an additional layer of insight. Key species that mark clean, high-quality water further illustrate Brook Trout-friendly conditions. Algae are the base of the food web, responding within days to light, temperature, pH, and nutrients. Together, fish and algae tell a story neither can tell alone.

**Shannon diversity** was calculated separately for fish communities, **H(f)**, and algal communities, **H(a)**, using the Shannon index: H = −Σ pᵢ ln(pᵢ), where pᵢ is the proportion of total accepted reads assigned to taxon i within a sample. The index increases when more taxa are detected and when read counts are more evenly distributed among taxa. In this eDNA context, Shannon diversity should be interpreted as a standardized measure of detected community diversity based on relative read representation, not as a direct census of organism abundance. Higher values may indicate a more diverse and evenly represented biological signal, but interpretation as environmental quality requires comparison among sites, seasons, controls, and supporting ecological evidence. Shannon diversity is a widely used community-diversity metric that can support ecological interpretation when compared across samples and paired with other evidence.
...
**Water chemistry** values are inferred from biological indicator species unless otherwise stated — directionally reliable but not a substitute for direct measurement.
...
The Narraguagus River drains the remote forests of Washington County, Maine — one of the least-developed watersheds in the northeastern United States. This cluster of five sites captures the upper and middle reaches of the West Branch and its tributaries, sampled in November 2023 at leaf-off when eDNA from other taxa is minimal and the fish signal is clearest. The Narraguagus is part of federally designated critical habitat for the Gulf of Maine Distinct Population Segment (DPS) of Atlantic Salmon, and it supports wild Brook Trout in its cold headwater tributaries. Here, two out of five locations have brook trout DNA and salmon DNA is found in one location. All five sites are analyzed using both fish (MiFish 12S) and algal (23S rRNA). Algal community composition provides independent inference of water temperature, pH, dissolved oxygen, and nutrient status, substantially deepening the ecological interpretation beyond fish alone.
...
The supporting cast — Redbreast Sunfish (12.7%), White Sucker (8.5%), Shiner sp. (5.1%), *Esox* spp. (3.6%), 19 species total — reflects a complete, multi-guild community from benthic feeders to apex predators. The *Esox* detection is unresolved at species level; in Washington County, Maine, Chain Pickerel (*E. niger*) is the most likely candidate. H(f) = 2.16 is the highest fish Shannon Diversity index in the Maine dataset.
...
### Sentinel Signal
Finescale Dace + Brook Trout + Sea Lamprey + diverse diatom matrix = **multi-line reference condition signal**. Each indicator independently confirms high-quality, connected, soft-water habitat functioning at full ecological complexity.
...
### Sentinel Signal
Synura at 74% dominance + Brook Trout present = **phosphorus-limited oligotrophic soft-water system, not impaired but at the nutrient floor**. The Synura says dissolved phosphorus is near or below 10 μg/L and the water is clean and lean; the trout says it is still livable.
...
The fish community is moderate and ecologically coherent for this habitat type: Ninespine Stickleback (35.2%), Creek Chub (25.0%), Brook Trout (16.9%), Redbreast Sunfish (9.9%). Trout presence is the key signal — salmonids require cool, well-oxygenated, clean water. Their detection here confirms the system is not lethal; it is simply lean. H(f) = 1.69 with 9 species is consistent with a small, phosphorus-limited woodland brook: when TP is at or below 10 μg/L, algal growth is slow, invertebrate biomass is low, and the fish community supported above it is correspondingly modest in size and diversity.

### Native vs. Non-Native
All detected fish are native to Maine. Finescale Dace and Ninespine Stickleback, though not detected here at high abundance, are native soft-water specialists. Brook Trout eDNA confirmed (*Salvelinus* spp., 100% match).^[MiFish 12S cannot distinguish Brook Trout (*S. fontinalis*), Lake Trout (*S. namaycush*), or Arctic Char (*S. alpinus*) at this locus. Geographic context — small, cold, phosphorus-limited headwater tributary in Washington County, ME — strongly favors Brook Trout. Lake Trout prefer deep lakes; Arctic Char is documented in only a handful of Maine coldwater ponds.]
...
**Note:** pH 3.54 is the most acidic sample in this study — it may also be among the most acidic waters in the state.
...
An active industrial peat extraction operation upstream — Worcester Peat Mining — has been operating for well over a decade and is presumably the primary anthropogenic driver of the pH 3.54 condition documented here. This is not a speculative attribution. Peat mining directly exposes and destabilizes deep peat deposits, releasing sulfuric compounds, organic acids (fulvic and humic acid), and iron-sulfide oxidation products into drainage water. When disturbed peat is exposed to oxygen, pyrite (FeS₂) within the peat oxidizes to sulfuric acid — a process that continues for years and is extremely difficult to arrest once initiated. The resulting drainage is strongly acidic, metal-laden, and persistent.
...
H(f) ranges from 0.00 (single-species sites) to 2.16. Shannon Diversity of zero does not mean biological death — McCoy Brook has Creek Chub, UNT Lane Rd has Eel — it means the entire detectable fish community is a single species, which is itself an ecological signal.

The Maine gradient runs from active impairment (McCoy Brook, pH 3.54) through oligotrophic soft-water limitation (Crotch Camp Brook) to full ecological function with anadromous connectivity (Narraguagus Rt 193, West Branch). Acidification is the primary stressor. All detected fish are native. Where chemistry is adequate and ocean connectivity is intact, the system assembles a complete, multi-guild native fish community — from headwater dace to mainstem salmon — on a complex algal foundation.

---

## Detailed Species Detection Table

All five Narraguagus/Deblois sites. Read counts are fish-only (Actinopteri) unless noted. Percentages are per-site (reads ÷ total Actinopteri reads at that site). Site codes: **SF** = West Branch @ Sprague's Falls (n = 28,465); **CC** = Crotch Camp Creek (n = 35,496); **UNT** = UNT Lane Rd Deblois (n = 426); **MB** = McCoy Brook (n = 5,841); **R193** = Narraguagus Rt 193 (n = 40,026). Dash (—) = not detected. Multiple ESVs for the same taxon are summed. Match % reflects the highest-scoring ESV.

| Taxon | SF | CC | UNT | MB | R193 | Match | # Spp | Notes |
|---|---:|---:|---:|---:|---:|:---:|:---:|---|
| **SENTINEL — SALMONIDS** | | | | | | | | |
| *Salvelinus* spp. (Brook Trout) | 538 (1.9%) | 5,992 (16.9%) | — | — | — | 100% | 3 | 3-way tie: Brook Trout / Lake Trout / Arctic Char. Geography strongly favors Brook Trout at both sites. |
| *Salmo salar* (Atlantic Salmon) | — | — | — | — | 110 (0.3%) | 100% | 1 | Gulf of Maine DPS; federally endangered. Single ESV, unambiguous match. |
| **ANADROMOUS SPECIES** | | | | | | | | |
| *Alosa pseudoharengus* (Alewife) | — | — | — | — | 10,465 (26.1%) | 100% | 1 | Dominant at Rt 193. Confirmed alewife by sequence (1-SNP diagnostic vs. blueback herring). Ocean corridor confirmed. |
| *Anguilla rostrata* (American Eel) | 789 (2.8%) | 616 (1.7%) | 426 (100%) | — | 4,110 (10.3%) | 100% | 1 | Only fish detected at UNT Lane Rd. Catadromous; present throughout watershed. |
| *Petromyzon marinus* (Sea Lamprey) | 96 (*) | — | — | — | — | 100% | 1 | Hyperoartia — not counted in fish totals. Native; confirms anadromous migratory connectivity at Sprague's Falls. |
| **NATIVE GENERALISTS** | | | | | | | | |
| *Semotilus corporalis* (Fallfish) | 319 (1.1%) | — | — | — | 8,844 (22.1%) | 100% | 1 | Dominant at Rt 193. Largest native minnow; requires clean gravel for nest-building. Strong water quality indicator. |
| *Semotilus atromaculatus* (Creek Chub) | 4,965 (17.4%) | 8,857 (24.9%) | — | 5,841 (100%) | 1,135 (2.8%) | 100% | 1 | Only fish at McCoy Brook (pH 3.54). Acid-tolerant; present at all sites with adequate flow. |
| *Lepomis auritus* / *Lepomis* spp. (Redbreast Sunfish) | 8,811 (31.0%) | 3,509 (9.9%) | — | — | 5,240 (13.1%) | 100% | 1–3 | Dominant at Sprague's Falls. Benthic omnivore; requires stable, clean substrate. |
| *Catostomus commersonii* (White Sucker) | 5,596 (19.7%) | 344 (1.0%) | — | — | 3,402 (8.5%) | 100% | 1 | Tolerant generalist; indicates sufficient stream volume and substrate diversity. |
| *Pungitius* spp. (Ninespine Stickleback) | 2,906 (10.2%) | 12,451 (35.1%) | — | — | 449 (1.1%) | 100% | 2–7 | Dominant at Crotch Camp. Ninespine (*P. pungitius*) most likely in ME; multi-species ESV unresolved. |
| *Chrosomus neogaeus* (Finescale Dace) | 2,086 (7.3%) | 2,026 (5.7%) | — | — | 250 (0.6%) | 99–100% | 1 | Sentinel of pristine soft-water habitat; strongly associated with wild Brook Trout streams. |
| *Luxilus* spp. (Shiner) | 1,618 (5.7%) | — | — | — | 2,043 (5.1%) | 100% | 2–4 | Unresolved at species level across multiple ESVs. |
| *Notemigonus crysoleucas* (Golden Shiner) | 632 (2.2%) | 1,142 (3.2%) | — | — | 675 (1.7%) | 100% | 1 | |
| *Esox* spp. (Pickerel / Pike) | — | — | — | — | 1,413 (3.5%) | 100% | 2 | 2-way tie. Chain Pickerel (*E. niger*) most likely in Washington County, ME. |
| *Rhinichthys atratulus* (Blacknose Dace) | 77 (0.3%) | — | — | — | 327 (0.8%) | 100% | 1 | |
| *Micropterus* spp. (Bass) | 82 (0.3%) | — | — | — | 599 (1.5%) | 100% | 2–3 | Largemouth / Smallmouth unresolved. |
| *Perca flavescens* (Yellow Perch) | — | — | — | — | 288 (0.7%) | 100% | 1 | |
| *Ameiurus* spp. (Bullhead) | 46 (0.2%) | 473 (1.3%) | — | — | — | 100% | 2 | Yellow or Brown Bullhead; unresolved. |
| **MARINE / ANOMALOUS** | | | | | | | | |
| *Brevoortia* spp. (Menhaden) | — | — | — | — | 171 (0.4%) | 100% | 2 | Marine; 2-spp unresolved. Tidal eDNA signal at mainstem; ecologically plausible. |
| Gadidae spp. (Cod family) | — | — | — | — | 233 (0.6%) | 100% | 2 | 2-spp unresolved. Burbot (*Lota lota*), a freshwater gadid, is native to ME and the most ecologically plausible match. |
| *Scomber scombrus* (Atlantic Mackerel) | — | — | — | — | 136 (0.3%) | 100% | 1 | Marine pelagic; low read count. Possible tidal eDNA or trace contamination. |
| *Ictiobus* spp. (Buffalo) | — | — | — | — | 136 (0.3%) | 100% | 3 | Freshwater buffalo; not native to Maine or New England. Database artifact likely. |

(*) Sea Lamprey reads (96) are excluded from the Sprague's Falls Actinopteri total of 28,465; lamprey are Hyperoartia, not ray-finned fish.