...
Northern Inlet carries the cleanest algal water quality signal in the entire JVB5403 batch — and one of the strongest cold-oligotrophic signals in the full multi-batch dataset. Cyanobacteria at 0.2% is essentially absent; the community is dominated by cold-water chrysophytes (*Trachydiscus minutus* 24.9%, *Mallomonas* 14.1%, *Chromulina* 1.6%) and the brackish diatom *Halamphora coffeaeformis* (8.8%). The *Halamphora* signal, combined with American Eel at 42%, confirms this is a tidal or near-tidal reach — cold, clean salt-influenced water at a coastal Maine inlet. Ecologically excellent; not a Brook Trout reach due to tidal character, but the cold-water quality it represents is the same water that feeds upstream Brook Trout habitat.
...
| Salinity | Brackish — tidal influence confirmed | *Halamphora coffeaeformis* 8.8% |
...
| Species | Rel% | Note |
|---|---|---|
| *Semotilus corporalis* — Fallfish | 41.9% | Native clean-water indicator |
| *Anguilla rostrata* — American Eel | 41.9% | Native catadromous — tidal habitat |
| *Catostomus commersonii* — White Sucker | 16.2% | Native |
| **Brook Trout** | **Absent** | Tidal reach — not expected |
| **Atlantic Salmon** | **Absent** | |
...
| *Halamphora coffeaeformis* | Bacillariophyta | 8.8% | Brackish/marine diatom — tidal influence |
...
Northern Inlet is the ecological standout in JVB5403 — not because of its fish community (three common species, no salmon or trout) but because of what the algae reveal about the water itself. The near-total absence of Cyanobacteria (0.2%) is diagnostic: this water is cold, nutrient-poor, and well-oxygenated. The dominant taxa are *Trachydiscus minutus* (a cold soft-water xanthophyte uncommon enough to be a meaningful indicator), *Mallomonas* (the gold-standard chrysophyte for oligotrophic cold acidic water), and *Chromulina* — a chrysophyte assemblage that, when this dominant, essentially constitutes a biological certificate of clean water.

*Halamphora coffeaeformis* at 8.8% identifies the site as tidal or brackish-influenced. Northern Inlet is almost certainly a coastal tidal inlet in the East Machias / Machias Bay area where freshwater drainage meets tidal saltwater — a habitat where the cold oligotrophic chemistry of the Maine coastal watershed mixes with marine water. This explains both the Eel presence (obligate coastal migrant) and the Fallfish (surprisingly, at 42% — Fallfish typically prefer freshwater, but the gravel substrate of a clean inlet is suitable for them even at tidal influence).

The water chemistry signal here is exactly what you would want to find in the freshwater tributaries feeding this inlet. If this quality of water extends upstream, Brook Trout habitat conditions are likely present in the headwaters above the tidal reach.
...
**Fish:** H<sub>f</sub> = 0.95 · 3 species · ~16,200 reads
**Algae:** H<sub>a</sub> = 2.71 · 26 ESVs · 17,054 reads

### Sentinel Signal

East Machias Rt 9 in late July is a transitional zone — tidal freshwater with moderate summer nutrient loading, but with cold-headwater character still visible in the algal community. Cyanobacteria at 22% signal warm-season nutrient accumulation; *Mallomonas* (4.1%), *Trachydiscus* (4.6%), and *Mougeotia* (1.1%) push back with cold-water identity. *Halamphora coffeaeformis* at 3.2% confirms tidal salt influence reaching the Rt 9 sampling point. The fish story is cleaner than October: Blueback Herring 51%, Fallfish 35%, Eel 13% — a summer resident community with a strong clean-gravel endorsement from the Fallfish. The highest algal diversity in the batch (H<sub>a</sub> = 2.71) reflects the ecological richness of a tidal-freshwater mixing zone. No Brook Trout — expected at this reach and tidal elevation.
...
| Tidal influence | Confirmed | *Halamphora coffeaeformis* 3.2% |
...
| Species | Rel% | Note |
|---|---|---|
| *Alosa aestivalis* — Blueback Herring | 50.6% | Native anadromous — summer residents |
| *Semotilus corporalis* — Fallfish | 35.3% | Native clean-gravel indicator |
| *Anguilla rostrata* — American Eel | 13.4% | Native catadromous |
| *Micropterus dolomieu* — Smallmouth Bass | note only | Visual observation in sample notes — not detected by eDNA |
| **Brook Trout** | **Absent** | |
| **Atlantic Salmon** | **Absent** (contrast Oct 2024: not detected) | |

*Note: Sample collector observed Smallmouth Bass visually at this site. eDNA did not detect them — likely below detection threshold, too few individuals, or sampled upstream of their holding water. Electrofishing follow-up recommended.*
...
| *Halamphora coffeaeformis* | Bacillariophyta | 3.2% | Tidal/brackish diatom |
...
The algal community reflects a tidal freshwater mixing zone in summer: 22% Cyanobacteria signal warm-season nutrient accumulation consistent with agricultural or wetland drainage upstream, while *Mallomonas* (4.1%), *Trachydiscus* (4.6%), and *Mougeotia* (1.1%) confirm that cold headwater inputs are still reaching this reach. *Mougeotia* deserves emphasis: this filamentous soft-acid-water streptophyte is a consistent companion taxon in Maine Brook Trout streams. Its presence at a mainstem tidal site suggests the water chemistry, even at this downstream position, retains some cold-headwater character. *Halamphora coffeaeformis* (3.2%) marks the tidal mixing front.

*Nostoc linckia* at 2.0% is a rock-surface nitrogen-fixer that produces visible dark-colored crusts on exposed cobbles and bedrock. Its eDNA signal confirms exposed substrate — consistent with summer low-flow conditions on the East Machias. It is not a nutrient impairment indicator per se; it is an exposed-rock indicator.

The fish community shifted markedly between October 2024 (Blueback Herring 87%) and July 2025 (Blueback Herring 51%, Fallfish 35%). The dominant Fallfish signal — *Semotilus corporalis* at 35% is unusually high for a mainstem reach — is ecologically significant. Fallfish build large gravel mound nests in clean, flowing water with stable bed material. Their sustained dominance at this site is among the strongest endorsements of substrate quality in the dataset.

*Smallmouth Bass* were visually observed at this site by the sample collector but not detected by eDNA. This is not unusual: eDNA detection probability is low for rare or low-density individuals in a flowing system. If Smallmouth Bass are present in meaningful numbers, electrofishing would confirm density.
