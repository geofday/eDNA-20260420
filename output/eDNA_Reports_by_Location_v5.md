...
**Algae:** H<sub>a</sub> = 1.11 · 12 ESVs · 22,394 reads · **QC FLAG — marine contamination**

### Sentinel Signal

**This sample is dominated by marine organisms and should not be interpreted as reflecting Sawmill Brook water quality.** *Geminigera cryophila* (53.0%) is a marine cryptophyte characteristic of Antarctic and Arctic sea ice — a polar marine organism with no ecological relevance to a Massachusetts stream. *Ostreococcus tauri* (38.1%) is a marine picoeukaryote — one of the smallest known eukaryotic cells, found in open-ocean euphotic zones worldwide. Together these two marine species account for 91.1% of all algal reads. The most likely explanation is coastal marine aerosol deposition: the School Street Sawmill Brook site is within 2 km of Manchester Harbor, and in March, wind-driven sea spray carries marine microalgae inland. The fish panel returned no reads, consistent with low eDNA shedding in winter cold water — not a sample failure. The algal QC contamination does not affect the fish result. No ecological interpretation of water chemistry is possible from this algal sample.
...
### Algal Community — QC FLAG

| Taxon | Phylum | Rel% | QC Note |
|---|---|---|---|
| *Geminigera cryophila* | Cryptophyta | 53.0% | **Marine ice-alga — polar ocean. Contamination.** |
| *Ostreococcus tauri* | Chlorophyta | 38.1% | **Marine picoeukaryote — open ocean. Contamination.** |
...
| *Skeletonema pseudocostatum* | Bacillariophyta | 0.5% | Marine diatom |

### Narrative

The School Street sample in March 2025 returned a 23S library dominated by marine polar organisms — *Geminigera cryophila* (Antarctic sea ice) and *Ostreococcus tauri* (open ocean) — that have no plausible ecological connection to a freshwater stream in Essex County, Massachusetts. This is the strongest marine contamination signal in the full multi-batch dataset.

The most likely mechanism is coastal aerosol: Manchester-by-the-Sea is a coastal town on the North Shore of Massachusetts Bay, and in March, sustained onshore winds from nor'easters and coastal storms carry marine aerosol — including marine microalgae — several kilometers inland. When these organisms settle on the water surface or into sample collection vessels, they are co-extracted and amplified alongside freshwater taxa. At this site, in this sample, the marine signal overwhelmed the freshwater signal entirely. A companion fish sample from the same location and date also returned no reads — consistent with winter conditions rather than sample failure.

**Recommendation:** The March School Street sample should be excluded from all ecological interpretation. The companion Sawmill Brook Elm Street sample from the same date (LZAC7T2X.1) did not show this contamination and returned an excellent ecological signal — see below.

### Native vs. Non-Native

Not applicable — marine contamination sample.
...
| Sawmill School St | Mar 2025 | 1.11 | — | **Marine contamination — exclude** | **Yes** |
...
- *Geminigera cryophila* / *Ostreococcus tauri* (Sawmill School Street) — marine contamination; exclude from ecological interpretation
