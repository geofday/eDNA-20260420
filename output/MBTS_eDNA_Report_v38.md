...
**This report states only what the data shows.** It does not hedge, model, estimate, or speculate beyond the evidence. eDNA is an emerging science and while this is a best-effort analysis there may be mistakes; this preliminary report is shared for feedback more than as established fact. If a species is detected (no matter how unexpected), or not detected, that is what is written. The core of eDNA science is statistical likelihood drawn from billions of complete and fragmented DNA strands — results represent a percentage of detection probability more than a census of individuals, though relative abundance is a natural inference. If a reading is ambiguous, the ambiguity is named and the most likely interpretation is stated directly. Unsupported qualifications are not a substitute for data.

---

## About This Report

This report covers water samples from 12 distinct sites in and around the Sawmill Brook / Cat Brook watershed in Manchester-by-the-Sea, MA, spanning November 2023 through November 2025. It also includes one marine sample at Proctor Point Dock (Manchester Harbor, June 2025), into which Sawmill Brook empties — providing ecological context for the watershed's coastal outlet.

The Manchester-by-the-Sea Brook Trout Monitoring Program (MBTS) tracks the health and status of Sawmill Brook — a small suburban coastal stream that drains southwest into Manchester Harbor. The sampling network covers the full longitudinal gradient: from Second Pond and Cat Brook headwaters through the main stem, from the estuarine School Street reach to the tidal limit at Fire Station.

Brook Trout (*Salvelinus fontinalis*) are the primary monitoring target. Their presence or absence at each site tells a story about possible anadromy, water quality, thermal conditions, and habitat connectivity. All other species detected — from Golden Shiner to Mummichog — are interpreted in relation to that central question: is this fresh-to-salt water continuum livable for Brook Trout, and what is limiting or sustaining their population?
...
**Shannon Diversity** is used throughout: **H(f)** for fish, **H(a)** for algae (formula: −Σ p·ln p). A higher value means more even distribution of reads across species — a proxy for ecological complexity and environmental quality.
...
**Ecological complexity** is highly favorable to healthy ecosystems. Complex systems are more robust, more durable, more adaptable to environmental change, and more capable of supporting migration and reproduction — and rich sources of food at all trophic levels. Shannon Diversity (H) captures this: higher values mean more species contributing meaningfully to the community — not one dominant species and noise.

**Read counts** are proportional, not absolute [T8].

Water chemistry values are **inferred** from biological indicator species unless otherwise stated — directionally reliable but not a substitute for direct measurement. pH values are calibrated; residual uncertainty ±0.2 pH unit. Temperature readings are reported in °F. Field data are presented site-by-site where available.

**Site order:** Sites are presented upstream-to-downstream where possible, followed by Proctor Point marine reference.

**Methods:** All samples were collected using Jonah Ventures (JV) eDNA field kits following recommended field-sterile procedures. All samples were mailed to JV for processing. Fish samples were analyzed using the MiFish 12S rRNA barcode; several samples were also analyzed for algae using the 23S rRNA barcode. Results were processed in MS Excel and later using Artificial Intelligence (Claude / OpenAI) for analysis.

---


## Field pH & Temperature — All MBTS Vivosun Measurements

**Average pH across all 8 field readings: 6.66** (range 6.15–7.05) — every measurement falls within the Brook Trout adult pH tolerance range (5.0–7.5). The full MBTS watershed, at every site and season measured, presents chemically viable habitat for Brook Trout. No site has been found to be pH-excluded.

| Date | Site | pH | Temp °F | Brook Trout context |
|---|---|---|---|---|
...
The fish community straddles two worlds: Fourspine Stickleback (32.4%) and Mummichog (8.5%) signal tidal/estuarine influence; Golden Shiner (14.9%) and Sunfish sp. (24.5%) are freshwater warm-water taxa. American Eel (17.3%) bridges both. Yellow Perch (1.4%) adds tolerant generalist presence. Rainbow Smelt (0.2%) is an anomalous detection — not documented in this system; unconfirmed pending ESV review [T9]. This is a mixing zone — freshwater meeting tidal backwater — and the fish community reflects that ecotone exactly. Ecotones are often biodiversity hotspots precisely because they receive inputs from both adjacent systems simultaneously. H(f) = 1.62 is the highest in the Massachusetts dataset.
...
The fish community is ecologically coherent: Alewife at 63% confirms the pond supports a lake-run population (landlocked Alewife are common in Manchester-area coastal ponds); Tessellated Darter at 5% endorses substrate quality. *Esox* spp. at 1.5% is native pickerel [T2].

### Native vs. Non-Native

Alewife, Tessellated Darter, Eel are native. Rock Bass is native to the Great Lakes drainage but introduced to coastal MA. *Esox* spp. — native pickerel [T2].
...
The absence of fish reads in March is not concerning — it corroborates the cold water conditions the algae are describing. Brook Trout shedding rates in water below 46°F are extremely low. The absence of fish DNA is not an absence of fish.
...
Mummichog 47.8% + Fourspine Stickleback 10.1% = tidal estuarine site in April. Eel 10.8% = ocean connectivity. *Lepomis* spp. 13.2% at a tidal site = freshwater pond or slow-water tributary input nearby. *Salmo* spp. 1.2% = genus-level only [T1]. Tomcod trace = early spring estuarine movement. No Brook Trout — tidal site.
...
MBTS #3 in April is a Manchester-by-the-Sea tidal site — Mummichog + Fourspine Stickleback = estuarine mixing zone. *Lepomis* spp. at 13.2% is a striking component for a tidal site — these freshwater sunfish signal substantial freshwater input to the tidal zone, likely from connected pond or slow-water reach. *Salmo* spp. at 1.2% is genus-level only — Brown Trout or Atlantic Salmon cannot be distinguished from this barcode [T1]. The freshwater fish ensemble (Golden Shiner, Yellow Perch, Lepomis) confirms active tidal-freshwater mixing at this site. Atlantic Tomcod (*Microgadus tomcod*) in April is consistent with their spring estuarine movement.
...
**Site:** Sawmill Brook / Manchester-by-the-Sea (MBTS) system, MA. "Lincoln Pool" is a named pool within the Sawmill Brook watershed. GPS coordinates in the Jonah Ventures record show  (likely a data entry artifact — user-confirmed MBTS system site).
...
Fish community: Golden Shiner dominant with a substantial *Lepomis* spp. component and Eel. The Fourspine Stickleback confirms tidal/estuarine connectivity with the lower Sawmill Brook system. **Brook Trout (*Salvelinus* spp.) is detected at 0.6% (~285 reads)** — a low but real signal, consistent with cold upstream reach connectivity within the MBTS watershed. *Micropterus* spp. at 3.5% is genus-level only [T1].
...
**Fish:** H(f) = 0.90 · 11 taxa · 10,319 reads *(includes all genus-level ESVs; see cormorant QC note)*
...
### QC Note — Cormorant Fecal eDNA [T5]
...
> ⚠️ **Critical thermal finding — July 9, 2025.** At 75.9°F, Atwater Ave water temperature is at or beyond the acute lethal threshold for Brook Trout (death commonly reported above 73–75°F). This is the highest temperature recorded in the MBTS dataset. Brook Trout detected here in June 2025 (1.1%, eDNA sample) are almost certainly absent from this reach by July — either dead, displaced to cold groundwater refugia, or retreated to cooler upstream reaches. Sculpin, also detected in June, share the same thermal sensitivity. The summer temperature regime at this site is **incompatible with Brook Trout residency** without accessible cold-water refugia nearby. The corrected June pH of 6.15 is within comfortable adult Brook Trout range — pH is not a stressor at this site.
...
## November 22, 2025 Sampling Batch -- MBTS Sawmill Brook System

*Source: MBTS_eDNA_Full_Report chart data (April 2026). Batch IDs to be confirmed against JV Master.*

Three sites sampled on the same date provide a longitudinal snapshot of the full Sawmill Brook gradient in late autumn, which is the peak of Brook Trout spawning season.

---

## Upper Sawmill Brook | Nov 22, 2025

**Fish: 6 species detected, H(f) = 0.91 (low-moderate) | No algae data this event**

### Sentinel Signal
Golden Shiner dominant (57.9%) + Bluegill Sunfish co-dominant (36.2%) + Largemouth Bass = **warm-water lentic assemblage. Brook Trout: not detected.** November is peak Brook Trout spawning season. This is the single most ecologically significant finding in the November 2025 batch.

### Fish Community

| Species | % | Notes |
|---|---|---|
| Golden Shiner | 57.9% | Lentic warm-water specialist |
| Bluegill Sunfish | 36.2% | Pond/slow-water sunfish |
| American Eel | 2.6% | Catadromous; confirms downstream connectivity |
| Largemouth Bass | 2.1% | Warm-water predator |
| Sucker spp. | 0.7% | Native; tolerant generalist |
| Brown Bullhead | 0.2% | Tolerant warm-water benthic |
| *Longear Sunfish* | *0.3%* | *Database artifact [T3] — excluded* |
| **Brook Trout** | **NF** | **Not detected** |
| Fourspine Stickleback | NF | -- |
| Mummichog | NF | -- |
| Rainbow Smelt | NF | -- |
| Smallmouth Bass | NF | -- |
| Creek Chub | NF | -- |
| Yellow Perch | NF | -- |
| Atlantic Menhaden | NF | -- |

### Narrative
Brook Trout were not detected at Upper Sawmill Brook on November 22, 2025. This is the spawning season -- Brook Trout are at peak behavioral activity in November, moving to gravel redds in cool, well-oxygenated reaches. The absence of a detectable signal at this site, in this month, is the most significant negative result in the November batch.

The fish community that was detected -- Golden Shiner (57.9%) and Bluegill Sunfish (36.2%) together accounting for 94% of reads -- is a warm-water, lentic assemblage. This is the community of a pond, impoundment, or slow backwater, not a flowing cold-water stream. H(f) = 0.91 reflects a two-species-dominated system with limited diversity.

American Eel (2.6%) confirms that some downstream connectivity to tidal water is maintained. Largemouth Bass (2.1%) and Brown Bullhead (0.2%) are warm-water tolerant species consistent with the lentic signal.
...
## Below School St | Nov 22, 2025

**Fish: 9 species detected, H(f) = 1.40 (good diversity) | No algae data this event**

### Sentinel Signal
Mummichog (42.2%) + Fourspine Stickleback (31.6%) + American Eel (15.6%) = **tidal freshwater-to-oligohaline transition, fully functional**. Brook Trout confirmed at **4.8%** -- detected in November during spawning season at the tidal reach.

### Fish Community

| Species | % | Notes |
|---|---|---|
| Mummichog | 42.2% | Tidal/estuarine indicator |
| Fourspine Stickleback | 31.6% | Brackish-water specialist |
| American Eel | 15.6% | Catadromous; ocean connectivity confirmed |
| **Brook Trout** | **4.8%** | **Confirmed -- spawning season detection** |
| Golden Shiner | 2.9% | Freshwater component |
| Bluegill Sunfish | 1.5% | Warm-water sunfish |
| Largemouth Bass | 1.4% | Warm-water predator |
| Brown Bullhead | 0.1% | Tolerant benthic |
| Smallmouth Bass | 0.1% | Clean-water indicator |

### Narrative
The tidal character of Below School St is unchanged: Mummichog and Fourspine Stickleback together account for 73.8% of reads, defining this site's identity as unambiguously as any chemical measurement could. American Eel at 15.6% confirms open ocean connectivity.

Brook Trout at 4.8% is confirmed -- detected at the tidal reach of Sawmill Brook during spawning season. H(f) = 1.40 matches the November 2023 sampling at this site, indicating a stable diverse estuarine assemblage.

The freshwater component (Golden Shiner 2.9%, Bluegill Sunfish 1.5%, Largemouth Bass 1.4%) reflects upstream mixing -- pond-origin fish eDNA carried downstream or present in the tidal backwater. Smallmouth Bass (0.1%) at this site is notable; their low-level detection is consistent with occasional dispersal from upstream reaches.

### Native vs. Non-Native
All detected fish are native to the coastal New England estuarine environment. No non-native fish signal.

---

## Southern Boundary / Essex Club | Nov 22, 2025

**Fish: 8 species detected, H(f) = 1.63 (good diversity) | No algae data this event**

### Sentinel Signal
Fourspine Stickleback (32%) + Mummichog (8%) = tidal/estuarine influence present. Bluegill Sunfish (24%) + Golden Shiner (15%) = freshwater warm-water input. **Brook Trout: not detected.** Atlantic Menhaden (1%) -- flag for cormorant dietary artifact.

### Fish Community

| Species | % | Notes |
|---|---|---|
| Fourspine Stickleback | 32% | Brackish-water specialist; tidal marker |
| Bluegill Sunfish | 24% | Warm-water freshwater sunfish |
| American Eel | 17% | Catadromous; ocean connectivity |
| Golden Shiner | 15% | Freshwater lentic species |
| Mummichog | 8% | Tidal/estuarine indicator |
| Atlantic Menhaden | 1% | Marine schooling fish -- cormorant dietary artifact (see QC note) |
| Creek Chub | 1% | Native freshwater stream fish |
| Yellow Perch | 1% | Native freshwater tolerant generalist |
| **Brook Trout** | **NF** | **Not detected** |

### Narrative
Southern Boundary / Essex Club occupies an ecotone between the freshwater Sawmill Brook system and the tidal-influenced lower reach. The fish community reflects this mixed character: Fourspine Stickleback and Mummichog confirm tidal influence; Golden Shiner and Bluegill Sunfish indicate freshwater lentic input. H(f) = 1.63 is the highest in the November 2025 batch, consistent with ecotone sites receiving species from both adjacent systems.

Brook Trout were not detected. In November -- spawning season -- this absence is ecologically meaningful.

Creek Chub (1%) is a native stream fish preferring flowing water with gravel substrate -- more compatible with Brook Trout habitat than the lentic signal dominant at Upper Sawmill.

**Atlantic Menhaden QC note:** Atlantic Menhaden (*Brevoortia tyrannus*) are coastal marine schooling fish that do not enter small tidal creeks. Their presence at 1% is consistent with cormorant dietary artifact, documented at the Atwater Site (JVB4981, June 2025) where Menhaden and marine prickleback (*Xiphister* spp.) were attributed to Double-crested Cormorant fecal input. The 1% Menhaden reading at Essex Club is not interpreted as live fish.

### Native vs. Non-Native
All detected fish are native to coastal New England. No confirmed non-native species. Atlantic Menhaden detection treated as cormorant dietary artifact.

---

## November 2025 -- Longitudinal Brook Trout Summary

| Site | Nov 22, 2025 | Prior detection |
|---|---|---|
| Upper Sawmill Brook | **NF** | Present historically (Golf Course reach Nov 2023) |
| Below School St | **4.8%** | 2.5% (Nov 2023); consistent presence confirmed |
| Southern Boundary / Essex Club | **NF** | No prior data at this site |

Brook Trout are confirmed present in the Sawmill watershed as of November 2025 -- detected at Below School St during spawning season. Their absence at Upper Sawmill Brook in the same month, with a warm-water lentic assemblage dominant at that site, is the primary finding of this batch.
